...
from cd_monitor.infrastructure.external.ai_handler import (
    download_all_images,
    get_ai_analysis,
    send_ntfy_notification,
    cleanup_task_images,
)
from cd_monitor.services.scraper._config_compat import (
    AI_DEBUG_MODE,
...
from cd_monitor.services.scraper.parsers import (
...
from cd_monitor.services.scraper._utils_compat import (
...
from cd_monitor.services.scraper.rotation import RotationPool, load_state_files, parse_proxy_pool, RotationItem
from cd_monitor.services.scraper.failure_guard import FailureGuard
from cd_monitor.services.scraper._account_strategy_compat import resolve_account_runtime_plan
from cd_monitor.infrastructure.persistence.storage_names import build_result_filename
from cd_monitor.services.scraper._dispatcher_compat import (
    ItemAnalysisDispatcher,
    ItemAnalysisJob,
)
from cd_monitor.services.scraper._price_history_compat import (
    build_market_reference,
    load_price_snapshots,
    record_market_snapshots,
)
from cd_monitor.services.scraper._result_storage_compat import load_processed_link_keys
from cd_monitor.services.scraper._seller_profile_compat import SellerProfileCache
from cd_monitor.services.scraper._pagination_compat import (
    advance_search_page,
