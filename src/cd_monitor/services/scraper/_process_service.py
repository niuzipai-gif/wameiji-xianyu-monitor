...
from cd_monitor.infrastructure.external.ai_handler import send_ntfy_notification
from cd_monitor.services.scraper._config_compat import STATE_FILE
from cd_monitor.services.scraper.failure_guard import FailureGuard
from cd_monitor.infrastructure.persistence.sqlite_task_repository import find_task_by_name_sync
from cd_monitor.services.scraper._utils_compat import build_task_log_path
