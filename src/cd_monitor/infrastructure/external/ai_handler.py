...
from cd_monitor.infrastructure.external.ai_message_builder import (
    build_analysis_text_prompt,
    build_user_message_content,
)
from cd_monitor.infrastructure.external.ai_response_parser import (
...
from cd_monitor.services.scraper._notification_compat import build_notification_service
from cd_monitor.services.scraper._utils_compat import convert_goofish_link, retry_on_failure
...
async def get_ai_analysis(product_data, image_paths=None, prompt_text=""):
    ...
    for attempt in range(max_retries):
        try:
            ...
            from cd_monitor.services.scraper._config_compat import get_ai_request_params
